...
class SignUpPasswordCreate extends StatefulWidget {
  String phoneNo;
  String code;
  SignUpPasswordCreate({required this.phoneNo,required this.code,Key? key}) : super(key: key);

  @override
  _SignUpResetPassword createState() => _SignUpResetPassword(phoneNo:phoneNo,code:code);
}

class _SignUpResetPassword extends State<SignUpPasswordCreate> {
  String phoneNo;
  String code;
  _SignUpResetPassword({required this.phoneNo,required this.code});
  ...
  void initState() {
    ...
    _sendAnalyticsEvent(signup_password_create);
  }
                                  ...
                                  onPressed: () async {
                                    if( value.passwordController.text.isEmpty || value.confirmPasswordController.text.isEmpty){
                                      ...
                                      if (_isInternet) {
                                        ...
                                        value.signupResetPassword(phoneNo,value.passwordController.text,context,code);
