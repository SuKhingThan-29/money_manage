...
class _ForgotPasswordScreen extends State<ForgotPasswordSmsScreen> {
  ...
  void initState() {
    ...
    _sendAnalyticsEvent(forgot_password_account);
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10,),
                          Text(
                            "Enter the phone number associated with".tr,
                            style: TextStyle(color: Colors.grey, fontSize: 12),
                          ),
                          Text(
                            "your account and we'll send a verification".tr,
                            style: TextStyle(color: Colors.grey, fontSize: 12),
                          ),
                          Text(
                            "SMS to reset your password".tr,
                            style: TextStyle(color: Colors.grey, fontSize: 12),
                          ),
                          Container(
                                  ...
                                  if(value.phoneNoController.text.isEmpty && !isPhoneNoStartWith){
                                    ...
                                    if (_isInternet) {
                                      ...
                                      if(value.languageChange!.code==myanmarCode && isPhoneNoStartWith){
                                        value.requestForgetPasswordSMS(value.phoneNoController.text,context,myanmarCode);
                                      }else if(value.languageChange!.code==cambodiaCode && isPhoneNoStartWith){
                                        value.requestForgetPasswordSMS(value.phoneNoController.text,context,cambodiaCode);
                                      }else{
